...
export const FIREBASE_CONFIG = {
  ...
  authDomain: readEnv("VITE_FIREBASE_AUTH_DOMAIN", "urbantales-login25.firebaseapp.com"),
  projectId: readEnv("VITE_FIREBASE_PROJECT_ID", "urbantales-login25"),
  storageBucket: readEnv("VITE_FIREBASE_STORAGE_BUCKET", "urbantales-login25.appspot.com"),
  messagingSenderId: readEnv("VITE_FIREBASE_MESSAGING_SENDER_ID", "309927220732"),
  appId: readEnv("VITE_FIREBASE_APP_ID", "1:309927220732:web:7a745ef3e8283f5a4b0e79"),
};
