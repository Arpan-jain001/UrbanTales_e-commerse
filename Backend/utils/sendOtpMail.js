...
export const sendResetPasswordOTP = async (email, otp) => {
  const html = `
    <div style="background:#fff;border:2px solid #FFCC00;padding:1.5rem 2.5rem;border-radius:18px;max-width:400px;margin:2rem auto;">
      <img src=\"https://drive.google.com/uc?export=view&id=1XxU_zf3_ZBDjuEWqGorEYUgBTzjoyaW_\" alt=\"UrbanTales\" style=\"width:140px;margin-bottom:14px;\"/>
  ...
  await sgMail.send({
    to: email,
    from: 'urbantales4@gmail.com', // Yahi sender SendGrid par verify hona chahiye!
